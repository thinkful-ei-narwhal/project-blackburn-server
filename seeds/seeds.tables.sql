...
VALUES
  ...
  You follow him out the door.', 'You couldn''t focus. You looked around each store but nothing seemed remarkable. Customers went in and out, no one or anything stood out. Caffeine will only take you so far. Maybe you''re just tired of the job.', 'https://c8.alamy.com/comp/MFJA5A/noir-criminal-detective-looking-through-blinds-for-a-clue-private-investigator-trying-to-solve-a-crime-perry-mason-MFJA5A.jpg', '../Assets/Sounds/bensound-badass.mp3', 'animals'),
  ...
  Great job. You solved the case. All it took was good old fashioned police work, and a liberal dose of coffee.', 'It was a bloodbath. You revealed yourself too early, and the suspects fled, bullets covering their retreat. Three of your officers are injured or dead, and your left leg has a sharp, pulsing pain. You hear sirens approaching as your vision fades to black.', 'https://noirencyclopedia.files.wordpress.com/2014/01/hotel-noir-3-the-shootout-during-the-heist.png', '../Assets/Sounds/bensound-badass.mp3', 'dictionary string');
