...
VALUES
  (1, 'The Call', 'google.com', 'The phone rings. You pick up the reciever it press it to your ear.  On the other line, a breathy voice asks you to find a man known only as the vvolf.  What a dumb name.  You start your research', 'google.com', 'bensound-theduel.mp3', 'animals'),
  (2, 'Noir Streets', 'google.com', 'Through your research you find a real name, Duane Reade.  You take to the foggy streets and start asking your usual contacts if they have heard of such a man.  Most point you to the pharmacy, but one man, a homeless man with a missing leg, tells you he knows something about the person.', 'google.com', 'bensound-theduel.mp3', 'animals'),
